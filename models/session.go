...
// Id doesn't exist
func GetSessionById(id int64) (v *Session, err error) {
	o := orm.NewOrm()
	v = &Session{Id: id}
	if err = o.QueryTable(new(Session)).Filter("Id", id).RelatedSel().One(v); err == nil {
		return v, nil
	}
	return nil, err
}
...
func DeleteSession(id int64) (err error) {
	o := orm.NewOrm()
	v := Session{Id: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
